        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletBalance = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRedeemedById = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ActivationCodes_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ActivationCodes_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ActivationCodes_Users_GeneratedById",
                        column: x => x.GeneratedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ActivationCodes_Users_LastRedeemedById",
                        column: x => x.LastRedeemedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContentItems_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VideoProgresses_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VideoProgresses_Users_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WatchSessions_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WatchSessions_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivationCodeId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    UpdatedBy = table.Column<string>(type: "text", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Enrollments_ActivationCodes_ActivationCodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LectureAccesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LectureAccesses_ActivationCodes_ActivationCodeId",
                        column: x => x.ActivationCodeId,
                        principalTable: "ActivationCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_LectureAccesses_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LectureAccesses_Users_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Transactions_ActivationCodes_ActivationCodeId",
                        column: x => x.ActivationCodeId,
                        principalTable: "ActivationCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Transactions_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WalletTransactions_ActivationCodes_ActivationCodeId",
                        column: x => x.ActivationCodeId,
                        principalTable: "ActivationCodes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WalletTransactions_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WalletTransactions_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradedByName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_MediaAssets_Lectures_LectureId",
                        column: x => x.LectureId,
                        principalTable: "Lectures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivationCodes_CourseId",
                table: "ActivationCodes",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_ActivationCodes_GeneratedById",
                table: "ActivationCodes",
                column: "GeneratedById");

            migrationBuilder.CreateIndex(
                name: "IX_ActivationCodes_LastRedeemedById",
                table: "ActivationCodes",
                column: "LastRedeemedById");

            migrationBuilder.CreateIndex(
                name: "IX_ActivationCodes_LectureId",
                table: "ActivationCodes",
                column: "LectureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Announcements_ScheduledPublishAt",
                table: "Announcements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuditLogs_IsAdminAction",
                table: "AuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContentItems_LectureId_OrderIndex",
                table: "ContentItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LectureAccesses_ActivationCodeId",
                table: "LectureAccesses",
                column: "ActivationCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_LectureAccesses_LectureId",
                table: "LectureAccesses",
                column: "LectureId");

            migrationBuilder.CreateIndex(
                name: "IX_LectureAccesses_StudentId_LectureId",
                table: "LectureAccesses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_ActivationCodeId",
                table: "Transactions",
                column: "ActivationCodeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_LectureId",
                table: "Transactions",
                column: "LectureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VideoProgresses_LectureId",
                table: "VideoProgresses",
                column: "LectureId");

            migrationBuilder.CreateIndex(
                name: "IX_VideoProgresses_StudentId_LectureId",
                table: "VideoProgresses",
                columns: new[] { "StudentId", "LectureId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_ActivationCodeId",
                table: "WalletTransactions",
                column: "ActivationCodeId");

            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_CourseId",
                table: "WalletTransactions",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_WalletTransactions_LectureId",
                table: "WalletTransactions",
                column: "LectureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WatchSessions_CourseId",
                table: "WatchSessions",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_WatchSessions_LectureId",
                table: "WatchSessions",
                column: "LectureId");

            migrationBuilder.CreateIndex(
                name: "IX_WatchSessions_StudentId_LectureId_StartedAt",
                table: "WatchSessions",
                columns: new[] { "StudentId", "LectureId", "StartedAt" });
        }
